...
public class LoginButton extends Button {
        ...
        public LoginButton(String text) {
            ...
            this.addEventHandler(MouseEvent.MOUSE_CLICKED,event -> {
                admin.setAccount(loginUsernameField.getUsername());
                admin.setAdminPassword(loginPasswordField.getPassword());
                Result result = loginService.login(admin);
                if (result.getCode()==200){
                    System.out.println("成功");
                    System.out.println("username："+ admin.getAccount());

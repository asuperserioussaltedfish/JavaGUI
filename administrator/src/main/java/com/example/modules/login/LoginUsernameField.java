    ...
    public LoginUsernameField(){
        ...
        usernameField.addEventHandler(MouseEvent.MOUSE_ENTERED,event -> {
            ...
            if(!textField.isFocused()){
                ...
                usernameField.setStyle("-fx-border-color:#FFFFCC");
                icon.setStyle("-fx-text-fill: #FFFFCC");
        ...
        usernameField.addEventHandler(MouseEvent.MOUSE_EXITED,event -> {
            if(!textField.isFocused()){
                usernameField.setStyle("-fx-border-color: #4A2500");
                icon.setStyle("-fx-text-fill: #4A2500");

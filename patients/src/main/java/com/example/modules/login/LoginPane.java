...
public class LoginPane extends BorderPane {
    ...
    public LoginPane(){
        ...
        // 创建艺术字文本
        Text text = new Text("patient login");

        // 设置艺术字使用的字体、大小、颜色
        text.setFont(Font.font("MV Boli", 50));
        text.setFill(Paint.valueOf("#111724"));

        // 将图片设置为背景图片
        Image backgroundImage = new Image("image/login.png");
        ...
        //设置vBox最小宽度，防止按钮靠在最右侧
        vBox.setMinWidth(630);
        // 登录表单放在右边
        this.setRight(vBox);
        // 设置LoginPane最大尺寸
